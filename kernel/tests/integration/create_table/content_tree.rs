...

    {
        ...
        leaf1.add_files(
            ...
            create_add_files_metadata(
                add_files_schema,
                vec![
                    ("leaf1-part1.parquet", 1024, 1_000_000, Some(10)),
                    ("leaf1-part2.parquet", 2048, 1_000_001, Some(20)),
                ],
            )?,
        )?;
        ...
        leaf2.add_files(
            ...
            create_add_files_metadata(
                add_files_schema,
                vec![
                    ("leaf2-part1.parquet", 3072, 1_000_002, Some(30)),
                    ("leaf2-part2.parquet", 4096, 1_000_003, Some(40)),
                ],
            )?,
        )?;
