...
impl EvaluationHandler for ArrowEvaluationHandler {
    ...
    fn new_lookup_join_handler(
        ...
        key_column: &crate::schema::ColumnName,
        value_columns: &[crate::schema::ColumnName],
...
/// Cached Arrow schema for predicate output: always `{output: Boolean}`.
static PREDICATE_OUTPUT_SCHEMA: OnceLock<Arc<ArrowSchema>> = OnceLock::new();
