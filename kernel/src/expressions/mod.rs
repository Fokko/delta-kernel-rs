...
/// This is the inverse of `ParsePartitionValues` - it converts a typed struct back to string
/// values.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
impl ParsePartitionValuesExpression {
    pub(crate) fn new(map_expr: impl Into<Expression>, output_schema: SchemaRef) -> Self {
        Self {
